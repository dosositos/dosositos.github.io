...
name: repasar-textos
description: |
  Repasa lo redactado en dos ositos antes de publicarlo: relatos, notas, pies de
  foto, definiciones del diccionario y textos de pantalla. Quita lo que suena a
  IA — solemnidad de tarjeta, adjetivos de relleno, rachas de tres, rayas de
  más, frases que servirían para cualquier pareja — y cuida el voseo
  nicaragüense. Nunca toca las palabras reales de ellos dos. Se corre después de
  escribir y antes de `npm run revisar`. Basado en la guía de Wikipedia «Signs
  of AI writing».
license: MIT
metadata:
  version: "2.11.2"
  origen: skill humanizer 2.11.2, renombrado para que no compita con la copia
...
Antes de usar este skill en *dos ositos*, leé [voz-del-proyecto.md](voz-del-proyecto.md):
qué archivos se repasan, cuáles son palabras reales que no se tocan nunca, y cómo
suena el español de aquí.
