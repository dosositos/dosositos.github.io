 ...
 *
 * Se guarda **el capítulo alcanzado y nada más**. El avance de adentro
 * del capítulo no: si cierra la página a mitad de la subida de Boo,
 * vuelve a empezar ese capítulo, pero nunca tiene que volver a pasar
 * uno que ya ganó.
 *
 * Es a propósito. Guardar el hito exacto convertiría cerrar la página
...
export function anotarCapitulo(capitulo: number, pasitos: number, caidas: number) {
